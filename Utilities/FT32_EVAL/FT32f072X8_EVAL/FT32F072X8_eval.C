...
/** @addtogroup FT32_EVAL
  * @{
  */

/** @addtogroup FT32072X_EVAL
  * @{
  */

/** @defgroup FT32072X_EVAL_LOW_LEVEL 
  * @brief This file provides firmware functions to manage Leds, push-buttons, 
  *        COM ports, SD card on SPI and temperature sensor (LM75) available on 
  *        FT32072X-EVAL evaluation board from FMD.
  * @{
  */
...
/** @defgroup FT32F072X8_EVAL_LOW_LEVEL_Private_Functions
  * @{
  */
...
/**
  ...
  * @retval None
  */
void FT_EVAL_LEDInit(Led_TypeDef Led)
{
...
/**
  ...
  * @retval None
  */
void FT_EVAL_LEDOn(Led_TypeDef Led)
{
...
/**
  ...
  * @retval None
  */
void FT_EVAL_LEDOff(Led_TypeDef Led)
{
  GPIO_PORT[Led]->BSRR = GPIO_PIN[Led];
}
...
/**
  ...
  * @retval None
  */
void FT_EVAL_LEDToggle(Led_TypeDef Led)
{
...
/**
  ...
  * @retval None
  */
void FT_EVAL_PBInit(Button_TypeDef Button, ButtonMode_TypeDef Button_Mode)
{
  GPIO_InitTypeDef GPIO_InitStructure;
...
/**
  ...
  */
uint32_t FT_EVAL_PBGetState(Button_TypeDef Button)
{
  /* There is no Wakeup button on FT32F072X8-EVAL. */
...
/**
  ...
  * @retval None
  */
void FT_EVAL_COMInit(COM_TypeDef COM, USART_InitTypeDef *USART_InitStruct)
{
  GPIO_InitTypeDef GPIO_InitStructure;
...
/**
  ...
  * @retval None
  */
uint8_t FT_SPI_WriteRead(uint8_t Data)
{
  uint8_t tmp = 0x00;
